        ...
        <div class="container">
            <div class="navbar-header">
              <!-- responsive nav button -->
                ...
                <!-- /responsive nav button -->
                <a href="login_panal.php" class="w3-bar-item w3-button w3-red w3-mobile"><img src="../images/logo.jpg" height="40" width="100" /></a>
...
<!--						<center><h4>Lakshit Garg</h4></center>-->
			...
			<div class="contact-info col-md-6 wow fadeInUp" data-wow-duration="500ms">
				...
				<div class="contact-details">
					...
					<div class="con-info clearfix">
						...
						<span>Phone: _91-9061543942</span>
					</div>
